...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.rainyday.com']
    env.dotenv_path = '/home/ubuntu/dev/rainyday/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.rainyday.com']
    env.dotenv_path = '/home/ubuntu/qa/rainyday/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.rainyday.com']
    env.dotenv_path = '/home/ubuntu/prod/rainyday/.env'
    env.config_setter = fab.run
