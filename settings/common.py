"""Django settings for rainyday project.
...
APPS_DIR = ROOT_DIR.path('rainyday')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'rainyday.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'EXCEPTION_HANDLER': 'rainyday.base.exceptions.exception_handler',
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/rainyday'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'rainyday.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'rainyday.base.views.csrf_failure'
